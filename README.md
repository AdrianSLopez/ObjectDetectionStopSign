...
<h2>1. Data Collecting</h2>
  ...
  <p><i>ls folderName(folder that stores all negative images)/* > (txt file that you want to store the paths of the negative images)</i<</p>
...
<p align="center"><img src="https://github.com/AdrianSLopez/ObjectDetectionStopSign/blob/main/ReadMeMedia/Labeling.jpg"></p>
  ...
  <p><i>- opencv_annotation -images=(filepath of positive images) -annotations (filename of where you want to save the labeling *.txt*) *My annotation file name is a.txt</i></p>
